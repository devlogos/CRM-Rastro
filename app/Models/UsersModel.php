...
class UsersModel
{
    ...
    {
        $sql =
            "SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = :schema AND TABLE_NAME = 'user_permissions' AND (COLUMN_NAME <> 'Id' AND COLUMN_NAME <> 'user_id')";
