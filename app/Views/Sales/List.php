        ...
        <div class="card mt-2">
            <div class="card-header">
                <form class="form-inline">
                    ...
                    <div class="form-group mt-2 mr-2">
                        <select name="status_id" class="form-control select2" id="status_id" multiple="multiple">
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card mt-2">
                    <div class="card-body">
                        <form id="scheduled-sale" class="scheduled-sale" onsubmit="return valNewSale()" method="post">
                            ...
                            <div class="form-group">
                                <label for="client_id"><span class="mr-1 required">*</span>Cliente</label>
